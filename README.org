...
New brushes are available for dotted lines. They come in 4 flavors:
- 3 dots vertical, 2 dots horizontal, either thin or thick,
- 4 dots both vertical & horizontal, either thin or thick.
...
Dotted lines were already available through the style modifiers on a
rectangular region. The new brushes add the option to instantly draw
dotted lines.

See [[#brush-style][Brush style]].

Additionally, leakeage when moving rectangular regions now correctly
leak dotted lines.

See [[#moving-a-rectangular-region][Moving a rectangular region]].
