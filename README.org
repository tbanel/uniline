...
Tabulation characters were taken into account, except when drawing
right onto a TAB. This is fixed: a tabulation behave as a
space. Non-breakable spaces and punctuation spaces are also now
regarded as spaces.

Rectangles are first untabified (if there are TABs) before moving
them. This avoids some rare instances of misalignment.

See [[#what-about-t-tabs][What about \t tabs?]].
