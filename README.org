...
Additional brushes are available. They give a 3D aspect to boxes.
...
3D brushes are experimental. They are available only with the Hydra
interface. Transient coming soon.

See [[#25d-brushes][3D brushes]].
...
** 3D brushes
:PROPERTIES:
:CUSTOM_ID: 3d-brushes
:END:

12 composite brushes are available. (They are composite in the sense
that they combine elementary brushes). They are called 3D, aka 3
dimensions, because they give the illusion of a foreground shape which
casts its shadow on the background. In the litterature they are
usually refered to as 2.5 dimensions.

Currently, they are only accessible through the Hydra
interface. Transient coming soon. Type:

~<insert> b~, then one of the 12 shortcut letters.
...
The rectangle drawing and the contour tracing operate clock-wise, thus
creating etched out shapes.
