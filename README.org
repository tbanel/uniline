...
non-nil, then those keys must be prefixed by =INS= to change the
brush. Otherwise, they keep the meaning they had before entering
uniline-mode (usually self insertion).
